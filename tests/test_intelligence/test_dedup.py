...
def test_are_duplicates(deduplicator):
    ...
    assert deduplicator._are_duplicates(a, b)
...
def test_are_duplicates_different_hosts(deduplicator):
    ...
    assert not deduplicator._are_duplicates(a, b)
