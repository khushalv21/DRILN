...
class WorkflowEngine:
    ...
    def get_auto_actions(self, decisions: list[WorkflowDecision]) -> list[WorkflowAction]:
    ...
    def get_pending_actions(self, decisions: list[WorkflowDecision]) -> list[WorkflowAction]:
