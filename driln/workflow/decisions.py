...
class WorkflowAction(BaseModel):
    ...
    tool_config: dict[str, Any] | None = Field(None, description="Tool-specific options")
...
class WorkflowDecision(BaseModel):
    ...
    requires_approval: bool = Field(True, description="If True, user must approve before execution")
