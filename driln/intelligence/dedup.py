...
class FindingDeduplicator:
    ...
    def deduplicate(self, findings: list[dict[str, Any]]) -> tuple[list[dict[str, Any]], int]:
    ...
    def _pick_primary(self, i: int, j: int, findings: list[dict[str, Any]]) -> tuple[int, int]:
