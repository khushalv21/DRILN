...
RULES: list[RecommendationRule] = [
    ...
    RecommendationRule(
        ...
        recommendation=RuleRecommendation(
            ...
            rationale=(
                "Joomla detected — JoomScan checks for known Joomla vulnerabilities and misconfigurations"
            ),
            tool_name="joomscan",
        ),
    ),
    ...
    RecommendationRule(
        name="ssh_weak",
        condition=lambda ctx, tp: _has_service(ctx, "ssh") and _has_finding_keyword(ctx, "ssh", "openssh"),
        recommendation=RuleRecommendation(
            priority="medium",
            category="tool_suggestion",
    ...
    RecommendationRule(
        ...
        recommendation=RuleRecommendation(
            ...
            rationale=(
                "SNMP service detected — check for default community strings and information disclosure"
            ),
            tool_name="snmpwalk",
        ),
    ),
    RecommendationRule(
        ...
        recommendation=RuleRecommendation(
            ...
            rationale=(
                "RDP service detected — verify Network Level Authentication is enabled and service is patched"
            ),
        ),
    ),
    # ── Database ports ──────────────────────────────────────
    ...
    RecommendationRule(
        ...
        recommendation=RuleRecommendation(
            ...
            tool_name="nuclei",
            tool_config={
                "tags": ["default-login", "admin-panel"],
    ...
    RecommendationRule(
        ...
        recommendation=RuleRecommendation(
            ...
            rationale=(
                "SSL/TLS issues detected — verify cipher suites, protocol versions, and certificate chain"
            ),
            tool_name="testssl",
        ),
    ),
