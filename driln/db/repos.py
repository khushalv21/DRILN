...
class FindingRepository:
    ...
    async def bulk_create(self, findings: list[dict[str, Any]]) -> list[Finding]:
    ...
    async def update_correlation(self, finding_id: str, group_id: str) -> None:
    ...
    async def mark_deduplicated(self, finding_id: str, source_tools: list[str]) -> None:
